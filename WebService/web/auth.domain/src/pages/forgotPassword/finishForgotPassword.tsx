...
export const FinishForgotPassword = () => {
    return (
        <div className="h-screen">
            ...
            <div className="w-full bg-blue-500 py-4">
                ...
                <div>
                    <h1 className="text-white text-center uppercase text-lg tracking-widest">Request to reset password</h1>
                    <h2 className="text-white text-center text-3xl font-bold py-8">You have request to reset password successfully</h2>
                </div>
            </div>
            <div className="py-8">
